...
public class VirtualPets {
	...
	public VirtualPets(int thirst, int hunger, int bordom, int apperance, int health, int enegry, String petsName) {
		this.thirst = thirst;
		this.hunger = hunger;
		this.bordom = bordom;
	...
	public VirtualPets(String nameParameter, String descriptionParameter) {
